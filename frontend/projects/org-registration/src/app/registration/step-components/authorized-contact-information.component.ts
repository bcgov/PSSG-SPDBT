    ...
    <form [formGroup]="form" #formDirective="ngForm" novalidate>
      <div class="step">
        <div class="title mb-5">
          Please provide your work contact information:
        </div>
        <div class="row">
          <div class="offset-md-2 col-md-4 col-sm-12">
            <mat-form-field>
              ...
              />
              <mat-error *ngIf="contactGivenName.hasError('required')"
                >This is required</mat-error
              >
              <mat-error
                *ngIf="form.get('contactGivenName')?.hasError('pattern')"
              >
          ...
          <div class="col-md-4 col-sm-12">
            <mat-form-field>
              ...
              <input
                matInput
                formControlName="contactSurname"
                maxlength="40"
                [errorStateMatcher]="matcher"
              />
              <mat-error
                *ngIf="form.get('contactSurname')?.hasError('required')"
                >This is required</mat-error
              >
        ...
        <div class="row">
          <div class="offset-md-2 col-md-4 col-sm-12">
            <mat-form-field>
              ...
              />
              <mat-error
                *ngIf="form.get('contactJobTitle')?.hasError('required')"
                >This is required</mat-error
              >
            </mat-form-field>
          </div>
        ...
        <div class="row">
          <div class="offset-md-2 col-md-2 col-sm-12">
            <mat-form-field>
              ...
              ></mat-datepicker>
              <mat-error
                *ngIf="form.get('contactDateOfBirth')?.hasError('required')"
                >This is required</mat-error
              >
            </mat-form-field>
          </div>
          <div class="col-md-3 col-sm-12">
            <mat-form-field>
              ...
              />
              <mat-error
                *ngIf="form.get('contactPhoneNumber')?.hasError('required')"
                >This is required</mat-error
              >
            </mat-form-field>
          </div>
...
export class AuthorizedContactInformationComponent
  implements RegistrationFormStepComponent
{
