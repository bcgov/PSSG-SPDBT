    ...
    <form [formGroup]="form" novalidate>
      <div class="step">
        <div class="title mb-5">
          Do you have a team generic email or phone number?
        </div>
        <div class="row">
          <div class="offset-md-2 col-md-8 col-sm-12">
            ...
            >
              <mat-radio-button value="YES">
                <strong>Yes</strong>, we have a team inbox or generic
                organization email and central team phone number.
              </mat-radio-button>
                ...
                <div class="row mt-2">
                  <div class="offset-md-2 col-md-8 col-sm-12">
                    <mat-form-field>
                      ...
                      />
                      <mat-error
                        *ngIf="form.get('genericEmail')?.hasError('email')"
                      >
                        Must be a valid email address
                      </mat-error>
                      <mat-error
                        *ngIf="form.get('genericEmail')?.hasError('required')"
                ...
                <div class="row">
                  <div class="offset-md-2 col-md-4 col-sm-12">
                    <mat-form-field>
                      ...
                      <mat-error
                        *ngIf="
                          form.get('genericPhoneNumber')?.hasError('required')
                        "
                        >This is required</mat-error
                      >
                    </mat-form-field>
              ...
              <mat-radio-button value="NO">
                <strong>No</strong>, we have a team inbox or generic
                organization email and central team phone number.
              </mat-radio-button>
              <mat-error
                *ngIf="
                  (form.get('hasPhoneOrEmail')?.dirty ||
                    form.get('hasPhoneOrEmail')?.touched) &&
...
export class OrganizationInformationComponent
  implements OnInit, RegistrationFormStepComponent
{
  form!: FormGroup;
