...
export function apiGdsdTeamAppAnonymousSubmitPost(http: HttpClient, rootUrl: string, params?: ApiGdsdTeamAppAnonymousSubmitPost$Params, context?: HttpContext): Observable<StrictHttpResponse<GdsdTeamAppCommandResponse>> {
