...
@Component({
	selector: 'app-controlling-members-wizard-anonymous-update',
	template: `
		<mat-stepper
			linear
...
export class ControllingMembersWizardAnonymousUpdateComponent extends BaseWizardComponent implements OnInit, OnDestroy {
