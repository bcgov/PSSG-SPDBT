...
@Component({
	selector: 'app-step-controlling-members-checklist-update',
	template: `
		<app-step-section
			title="Checklist"
...
export class StepControllingMembersChecklistUpdateComponent implements LicenceChildStepperStepComponent {
