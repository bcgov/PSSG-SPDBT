...
@Component({
	selector: 'app-steps-controlling-members-citizenship-residency',
	template: `
...
export class StepsControllingMembersCitizenshipResidencyComponent extends BaseWizardStepComponent {
