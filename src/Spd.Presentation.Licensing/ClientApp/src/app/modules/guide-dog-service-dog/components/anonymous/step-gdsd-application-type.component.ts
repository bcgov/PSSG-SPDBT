...
@Component({
	selector: 'app-step-gdsd-application-type',
	template: `
...
export class StepGdsdApplicationTypeComponent implements OnInit {
	...
	ngOnInit() {
		this.commonApplicationService.setGdsdApplicationTitle(ServiceTypeCode.GdsdTeamCertification);
	}
	...
	onStepNext(): void {
		...
		switch (applicationTypeCode) {
			...
			case ApplicationTypeCode.Replacement: {
				this.router.navigateByUrl(
					GuideDogServiceDogRoutes.pathGdsdAnonymous(GuideDogServiceDogRoutes.GDSD_TEAM_ACCESS_CODE_ANONYMOUS)
				);
				break;
			}
		}
