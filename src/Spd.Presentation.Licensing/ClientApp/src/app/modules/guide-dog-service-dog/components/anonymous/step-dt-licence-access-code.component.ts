...
import { FormGdsdLicenceAccessCodeComponent } from '../shared/common-form-components/form-gdsd-licence-access-code.component';
...
export class StepDtLicenceAccessCodeComponent implements OnInit {
	...
	ngOnInit(): void {
		...
		this.commonApplicationService.setApplicationTitle(this.serviceTypeDogTrainer, this.applicationTypeCode);
	}
			...
			.subscribe((_resp: any) => {
				switch (this.applicationTypeCode) {
					case ApplicationTypeCode.Renewal: {
						this.router.navigateByUrl(
							GuideDogServiceDogRoutes.pathGdsdAnonymous(
								GuideDogServiceDogRoutes.DOG_TRAINER_APPLICATION_RENEWAL_ANONYMOUS
							)
						);
						break;
					}
					case ApplicationTypeCode.Replacement: {
						this.router.navigateByUrl(
							GuideDogServiceDogRoutes.pathGdsdAnonymous(
								GuideDogServiceDogRoutes.DOG_TRAINER_APPLICATION_REPLACEMENT_ANONYMOUS
							)
						);
						break;
					}
