...
@Component({
	selector: 'app-step-gdsd-personal-info',
	template: `
					...
					<div class="col-xxl-10 col-xl-10 mx-auto">
						...
						<ng-template #hasNameChanged>
							<app-alert type="info" icon="info">
								...
								<a
									aria-label="Navigate to change of name or address site"
									[href]="changeNameOrAddressUrl"
									target="_blank"
									>Visit ICBC</a
								>
...
export class StepGdsdPersonalInfoComponent implements OnInit, LicenceChildStepperStepComponent {
	title = '';
	subtitle = '';
