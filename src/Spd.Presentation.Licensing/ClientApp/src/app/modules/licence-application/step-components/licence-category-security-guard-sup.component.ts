...
export class LicenceCategorySecurityGuardSupComponent implements OnInit, LicenceFormStepComponent {
	...
	ngOnInit(): void {
		...
		this.title = this.optionsPipe.transform(SwlCategoryTypeCode.SecurityGuardUnderSupervision, 'SwlCategoryTypes');
	}
