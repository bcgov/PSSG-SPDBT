...
@Component({
	selector: 'app-step-business-licence-employeesxxx', // TODO delete this component?
	template: `
...
export class StepBusinessLicenceEmployeesxxxComponent implements OnInit, LicenceChildStepperStepComponent {
