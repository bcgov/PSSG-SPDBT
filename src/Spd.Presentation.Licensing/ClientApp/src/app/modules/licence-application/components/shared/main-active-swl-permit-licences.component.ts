...
import { MainLicenceResponse } from '@app/modules/licence-application/services/common-application.service';

@Component({
	selector: 'app-main-active-swl-permit-licences',
	template: `
...
export class MainActiveSwlPermitLicencesComponent {
