...
@Component({
	...
	template: `
		<div class="row">
			<div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 mb-3 mx-auto">
				<div class="row">
						...
						<div class="step-container">
							<div class="step-container__box step-container__border">
								...
								<div class="step-container__box__footer m-4">
									Don't have Business BCeID? <a class="large" (click)="onContinue()"> Register today </a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
						...
						<div class="step-container">
							<div class="step-container__box step-container__border">
								...
								<div class="step-container__box__footer m-4">
									Don't have BC Services Card? <a class="large" (click)="onContinue()"> Set up your account today </a>
								</div>
							</div>
							<p class="mt-4">
								If you don't have a BC Services Card app you can still apply, but you will not have access to features
