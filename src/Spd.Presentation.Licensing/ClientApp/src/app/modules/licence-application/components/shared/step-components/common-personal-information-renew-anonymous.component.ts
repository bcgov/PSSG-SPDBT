				...
				<div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 mx-auto">
					...
					<ng-container
						*ngIf="
						...
						"
					>
						<mat-checkbox formControlName="legalNameChanged" (change)="onUpdateInformation()">
							<span class="checklist-label">Update information</span>
						</mat-checkbox>
					</ng-container>
				</div>
			</div>
			<div class="row mt-2" *ngIf="legalNameChanged.value" @showHideTriggerSlideAnimation>
				<div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 mx-auto">
...
export class CommonPersonalInformationRenewAnonymousComponent implements OnInit {
	...
	onUpdateInformation(): void {
		if (this.legalNameChanged.value) {
			this.enableData();
		} else {
			this.disableData(true);
		}
	...
	get legalNameChanged(): FormControl {
		return this.form.get('legalNameChanged') as FormControl;
	}
