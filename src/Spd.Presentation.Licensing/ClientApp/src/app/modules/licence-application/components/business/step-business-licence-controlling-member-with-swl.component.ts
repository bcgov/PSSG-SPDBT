		...
		<section class="step-section">
			<div class="step">
				<app-step-title
					...
					subtitle="Add all controlling members of this business with an active security worker licence"
				></app-step-title>
...
export class StepBusinessLicenceControllingMemberWithSwlComponent implements LicenceChildStepperStepComponent {
