									...
									<ng-template #newOrRenewal>
										<div class="my-3">
											<mat-checkbox formControlName="check1" (click)="onCheckboxChange()">
												...
												to the public in every office in which I am permitted, under the licence, to carry on the
												security business.
											</mat-checkbox>
											<mat-error
												class="mat-option-error"
										...
										<div class="my-3">
											...
											<ul class="primary-text-data ms-5 my-0">
												<li>
													any change in the security business licensee’s residential or security business address;
												</li>
												<li>
													any change in the ownership or management of the security business, including without
													limitation the addition of any individual who has control or the ability to control the
													security business and its operations (Controlling Member)
												</li>
												...
												<li>
													a criminal charge laid or criminal conviction against any individual employed or engaged by
													the security business licensee for security work.
												</li>
											</ul>
										</div>
										<div class="my-3">
											<mat-checkbox formControlName="check4" (click)="onCheckboxChange()">
												The security business licensee will be required to surrender the security business licence and
												all duplicates to the Registrar in the event that the business ceases operation or does not have
												an employee(s) that holds a valid security worker licence of a type that matches the security
								...
								<div class="col-12">
									<mat-checkbox formControlName="agreeToCompleteAndAccurate" (click)="onCheckboxChange()">
										...
										>
											...
											have read and understand the <i>Security Services Act</i> and Regulations; and I confirm that I am
											aware of, understand and remain bound by the conditions attached to the security business licence
											as well as those placed on the security business licensee.
										</ng-container>
							...
							<div class="row">
								<div class="col-12">
									<app-alert type="info" icon="" [showBorder]="false">
										...
										All information regarding this application is collected under the <i>Security Services Act</i> and
										its Regulation and will be used for that purpose. The use of this information will comply with the
