				...
				<form [formGroup]="form" novalidate>
					<div class="row">
						<div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 col-sm-12 mx-auto">
							<mat-radio-group aria-label="Select an option" formControlName="hasExpiredPermit">
							...
							<mat-error
								...
								*ngIf="
									(form.get('hasExpiredPermit')?.dirty || form.get('hasExpiredPermit')?.touched) &&
									form.get('hasExpiredPermit')?.invalid &&
									form.get('hasExpiredPermit')?.hasError('required')
								"
					...
					<div class="row mt-4" *ngIf="hasExpiredPermit.value === booleanTypeCodes.Yes" @showHideTriggerSlideAnimation>
...
export class StepPermitExpiredComponent implements PermitChildStepperStepComponent {
	...
	get hasExpiredPermit(): FormControl {
		return this.form.get('hasExpiredPermit') as FormControl;
	}
