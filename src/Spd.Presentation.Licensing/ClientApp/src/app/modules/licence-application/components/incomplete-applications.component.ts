	...
	template: `
		<div class="container">
			...
			<section class="step-section my-4">
				<div class="row">
					<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3 mx-auto py-4">
...
export class IncompleteApplicationsComponent implements OnInit {
	...
	columns: string[] = ['rownumber', 'caseId', 'updatedOn', 'action'];

	constructor(private router: Router, private licenceApplicationService: LicenceApplicationService) {}

	ngOnInit(): void {
		const data: Array<ApplicationResponse> = [
			{ id: '1', caseId: 'CRE-NWQ3X7Y10528', updatedOn: '2023-09-26T19:43:25+00:00' },
			{ id: '2', caseId: 'CSK-RNS2V9K40521m', updatedOn: '2023-06-11T16:43:25+00:00' },
			{ id: '3', caseId: 'CLW-RPC2V8K10521b', updatedOn: '2023-03-07T19:43:25+00:00' },
			{ id: '4', caseId: 'CLW-UPC2V8K10521b', updatedOn: '2023-03-07T19:43:25+00:00' },
		];
