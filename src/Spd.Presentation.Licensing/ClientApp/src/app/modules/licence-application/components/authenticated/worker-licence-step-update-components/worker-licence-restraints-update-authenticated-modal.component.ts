...
@Component({
	selector: 'app-worker-licence-restraints-update-authenticated-modal',
	template: `
		...
		<div mat-dialog-content>
			<app-step-worker-licence-restraints [isCalledFromModal]="true"></app-step-worker-licence-restraints>
		</div>
...
export class WorkerLicenceRestraintsUpdateAuthenticatedModalComponent {
	constructor(
		private dialogRef: MatDialogRef<WorkerLicenceRestraintsUpdateAuthenticatedModalComponent>
