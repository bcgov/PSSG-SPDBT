...
@Component({
	selector: 'app-first-time-user-modal',
	template: `
...
export class FirstTimeUserModalComponent {
	...
	constructor(
		private dialogRef: MatDialogRef<FirstTimeUserModalComponent> // @Inject(MAT_DIALOG_DATA) public dialogData: UpdatePhotoDialogData
	) {}
