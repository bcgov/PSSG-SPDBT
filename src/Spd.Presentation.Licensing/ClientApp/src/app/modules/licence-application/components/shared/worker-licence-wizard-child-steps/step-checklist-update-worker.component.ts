					...
					<div class="row">
						<div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 mx-auto">
							<form [formGroup]="form" novalidate>
								...
								<p class="checklist-info">
									You can upload a new passport-quality photo of your face looking straight at the camera against a
									plain, white background. For further information on Passport Quality Photographs, please review the
...
export class StepChecklistUpdateWorkerComponent implements LicenceChildStepperStepComponent {
