		...
		<form [formGroup]="form" novalidate>
			<mat-accordion multi="true">
				<mat-expansion-panel class="mat-expansion-panel-border my-2 w-100" [expanded]="defaultExpanded">
					...
					<div class="row mt-2" *ngIf="controllingMembersWithSwlExist; else noBusinessStakeholdersWithSwlExist">
						<div class="col-12">
					...
					<ng-template #noBusinessStakeholdersWithSwlExist>
				...
				<mat-expansion-panel class="mat-expansion-panel-border my-3 w-100" [expanded]="defaultExpanded">
					...
					<div class="row mt-2" *ngIf="controllingMembersWithoutSwlExist; else noBusinessStakeholdersWithoutSwlExist">
