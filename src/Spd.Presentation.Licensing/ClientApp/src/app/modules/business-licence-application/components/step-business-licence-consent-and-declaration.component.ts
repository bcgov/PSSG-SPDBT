						...
						@if (isBusinessStakeholdersWithoutSwlExist) {
							<div class="mb-3">
								<app-alert type="warning" icon="warning">
									<p>
										After you submit your application, it will not proceed until we receive criminal record check
										consent forms from all controlling members and business managers.
									</p>
									<p>
