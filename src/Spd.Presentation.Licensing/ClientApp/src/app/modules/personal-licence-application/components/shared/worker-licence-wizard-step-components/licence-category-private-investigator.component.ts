				...
				<div @showHideTriggerSlideAnimation>
					<div class="text-minor-heading">
						...
						@if (
							...
							<span>
								Upload proof of registration in the Private Security Training Network online course Introduction to
						...
						@if (
							...
							<span> Upload document(s) providing proof of relevant knowledge and experience: </span>
						}
					</div>
					<div class="my-2">
						<app-file-upload
					...
					<div class="my-2">
						<div class="text-minor-heading mb-2">
							@if (
								...
								<span> Upload a copy of your course certificate </span>
							}
							@if (
								trainingCode.value ===
								privateInvestigatorTrainingCodes.CategoryPrivateInvestigator_TrainingOtherCoursesOrKnowledge
							) {
								<span>Upload document(s) providing proof of course completion or equivalent knowledge</span>
							}
						</div>
						<app-file-upload
