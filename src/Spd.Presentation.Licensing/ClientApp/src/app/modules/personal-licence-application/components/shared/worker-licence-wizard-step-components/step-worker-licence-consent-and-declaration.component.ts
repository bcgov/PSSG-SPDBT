						...
						@if (isSoleProprietorSimultaneousFlow && isAnonymous) {
							<div class="mb-3">
								<app-alert type="warning" icon="warning">
									After you submit your application and continue to the business licence application, you will not be
									able to return and make changes to this security worker licence application.
								</app-alert>
							</div>
						}
