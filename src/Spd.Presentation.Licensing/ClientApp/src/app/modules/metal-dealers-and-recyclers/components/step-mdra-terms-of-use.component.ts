				...
				<div class="row">
					<div class="offset-xxl-1 col-xxl-10 offset-xl-1 col-xl-10 col-lg-12 col-md-12 col-sm-12">
						<div class="conditions px-3 mb-3" (scroll)="onScrollTermsAndConditions($event)">
							<div class="fs-5 mt-2 mb-3">Terms of Use for Registering Online as a Metal Dealer or Recycler</div>
							<p>
								In these Terms of Use, "you" or "your" includes the individual using or accessing the Electronic Metal
								Dealing or Recycling Registration Portal (the "Site") on behalf of a metal dealer or recycler business
								to submit a new or renewal Metal Dealer or Recycler Registration. These Terms of Use apply to the online
							...
							<ol>
								...
								<li>
									...
									Site in general. However, you are encouraged to refer to the
									<i>Metal Dealers and Recyclers Act</i> and Regulation and other official information materials before
									registering online as a metal dealer or recycler.
								</li>
								<li>
								...
								<li>
									14. The Province reserves the right, at any time, to:
									<ol>
				...
				<div class="row my-2">
					...
					<div class="col-xxl-3 col-xl-4 col-lg-5 col-md-12 col-sm-12 mb-2">
						<a
							...
							download="MDRA Applicant Terms of Use"
...
export class StepMdraTermsOfUseComponent implements LicenceChildStepperStepComponent {
	...
	downloadFilePath = SPD_CONSTANTS.files.mdraApplicantTerms;
