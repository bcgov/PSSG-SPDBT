						...
						@if (isNewOrRenewal) {
							...
							<ol>
								...
								<li>
									...
									licence, including as applicable a Controlling Member’s request to submit to Prescribed Checks. In
									most instances, if you are accessing the Site on behalf of the security business, you will be required
									to authenticate through the Business BCeID of the security business you are authorized to represent.
									If you are accessing the site as a Controlling Member in your personal capacity, your identity will be
							...
							<ol>
								...
								<li>
									...
									Services and the Site in general. However, you are encouraged to refer to the
									<i>Security Services Act</i> and <i>Regulation</i>, any other legislation as it applies specifically
									to your security business, including the <i>Body Armour Control Act</i>,
									<i>Armoured Vehicle and After Market Compartment Control Act</i> and related <i>Regulations</i>, and
									other official information materials before submitting an update to, or request a replacement of, a
									security business licence online, including where applicable Prescribed Checks for a security business
									licensee or Controlling Member(s).
								</li>
								<li>
									2. THE SERVICES ARE PROVIDED “AS IS”, WITHOUT WARRANTY OF ANY KIND INCLUDING WARRANTY OF FITNESS FOR A
									PARTICULAR PURPOSE. USE OF THE SERVICES IS ENTIRELY AT YOUR OWN RISK AND YOU WILL BE LIABLE FOR ANY
									FAILURE TO ABIDE BY THESE TERMS OF USE.
								</li>
								<li>
								...
								<div class="fs-5 terms-subtitle">Authentication:</div>
								<li>
									You must be authenticated to submit an update to, or request a replacement of, a security business
									licence online, including as applicable a security business licensee or Controlling Member’s
									submission, or request to submit, to Prescribed Checks. In most instances, if you are accessing the
									Site on behalf of the security business, you will be required to authenticate through the Business
									BCeID of the security business you are authorized to represent. If you are accessing the site as a
									Controlling Member in your personal capacity, your identity will be verified through your BC Services
									Card account login, approved government-issued ID, or other approved authentication method as may be
								...
								<li>
									...
									to, or replacement of, the security business licence.
								</li>
								<div class="fs-5 terms-subtitle">Additional Terms and Personal Information Collection:</div>
								<li>
									You may be required to accept additional terms and conditions in order to use or access an Associated
...
export class FormBusinessTermsComponent {
	...
	bceidBluePagesUrl = SPD_CONSTANTS.urls.bceidBluePagesUrl;
