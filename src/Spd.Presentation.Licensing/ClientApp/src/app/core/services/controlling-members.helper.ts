...
export abstract class ControllingMembersHelper extends ApplicationHelper {
	...
	// 	const categoryData = { ...controllingMembersModelFormValue.categoryData };

	// 	if (categoryData.ArmouredCarGuard) {
	// 		const docs: Array<Blob> = [];
	// 		controllingMembersModelFormValue.categoryArmouredCarGuardFormGroup.attachments.forEach((doc: any) => {
	// 			docs.push(doc);
	// 		});
	// 		documents.push({
	...
	// 		const useDogs =
	// 			controllingMembersModelFormValue.categorySecurityGuardFormGroup.isRequestDogAuthorization === BooleanTypeCode.Yes;
	// 		if (useDogs) {
	// 			if (controllingMembersModelFormValue.categorySecurityGuardFormGroup.attachments) {
	// 				const docs: Array<Blob> = [];
	// 				controllingMembersModelFormValue.categorySecurityGuardFormGroup.attachments.forEach((doc: any) => {
	// 					docs.push(doc);
	// 				});
	// 				documents.push({
	...
	getSaveBodyBase(controllingMembersModelFormValue: any): any {
		...
		// 	if (categoryData.SecurityGuard) {
		// 		useDogs = controllingMembersModelFormValue.categorySecurityGuardFormGroup.isRequestDogAuthorization === BooleanTypeCode.Yes;
		// 	}

		// 	if (categoryData.PrivateInvestigator) {
		// 		const privateInvestigatorData = controllingMembersModelFormValue.categoryPrivateInvestigatorFormGroup;
