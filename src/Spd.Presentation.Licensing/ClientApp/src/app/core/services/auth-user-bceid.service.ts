...
export class AuthUserBceidService {
	...
	// bceidUserProfile: UserInfo | null = null;

	constructor(private router: Router, private userProfileService: UserProfileService, private dialog: MatDialog) {}

	//----------------------------------------------------------
	// *
	// *
	// async setUserOrgProfile(): Promise<boolean> {
	// 	if (!this.bceidUserProfile) {
