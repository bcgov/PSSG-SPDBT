...
public class PaymentsConfiguration
{
    ...
    public string UnauthPersonalLicPaymentCancelPath { get; set; } = "security-licensing/payment-cancel";
    ...
    public string AuthPersonalLicPaymentCancelPath { get; set; } = "security-licensing/payment-cancel";
    ...
    public string AuthBizLicPaymentCancelPath { get; set; } = "security-biz-licensing/payment-cancel";
