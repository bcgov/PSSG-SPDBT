						...
						>
							<ng-container *ngIf="orgData?.isCrrpa; else isPssoa">
								...
								<p>
									...
									Criminal Record Check Portal (the "Site") on their own behalf to submit an online request for a
								...
								<p>
									Your failure to abide by these Terms of Use may result in the suspension or cancellation of your use
									of or access to the Services. In addition, the Province reserves the right to pursue any remedy
								...
								<ol>
									...
									<li>
										...
										and disclosed in accordance with the Province’s
									...
									<li>
										Any personal information that may be collected from you on this Site is collected, used and
									...
									<li>
										...
										access to, and use of the services offered by, those Associated Services or the Payment Site is
									...
									<li>
										...
										<ol type="a">
											...
											<li>
												input or upload any information which contains viruses, Trojan horses, worms, time bombs or
												other computer programming routines that may damage or interfere with the performance or
												function of the Services or any Associated Service;
											</li>
											<li>
												divulge, share, compromise or permit any other person to use your login and password to access
												the Services;
											</li>
											<li>
									...
									<li>
										...
										or other equipment used to provide the Services.
									</li>
									<li>
									...
									<li>
										...
										consequential or other loss, claim, injury or damage, whether foreseeable or unforeseeable
										(including without limitation claims for damages for loss of profits or business opportunities, use
										of or inability to use the Services, interruptions, deletion or corruption of files, loss of
										programs or information, errors, defects or delays) arising out of or in any way connected with your
										or their access to or use of the Services or any failure by you or them to abide by these Terms of
										Use and whether based on contract, tort, strict liability or any other legal theory. The previous
										sentence will apply even if the Province or the provider of any Associated Service has been
							...
							<ng-template #isPssoa>
								...
								<p>
									In these Terms of Use, "you" or "your" includes the individual using or accessing the Electronic
									Criminal Record Check Portal (the "Site") on their own behalf to submit an online request for a
									criminal record check administered by the Personnel Security Screening Office.
								</p>
								<p>
									These Terms of Use are an agreement between you and His Majesty the King in Right of the Province of
								...
								<ol>
									...
									<li>
										...
										Human Resources Policy 14 – Security Screening, any related policy and other official information
										materials before submitting an online request for a criminal record check administered by the
									...
									<li>
										...
										the services offered by, those Associated Services is governed by such additional terms.
									</li>
									<li>
										Additional personal information may be collected from you by the providers of the Associated
										Services in accordance with their terms and any associated privacy statement(s).
