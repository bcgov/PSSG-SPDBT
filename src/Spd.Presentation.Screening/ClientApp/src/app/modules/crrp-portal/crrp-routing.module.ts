...
const routes: Routes = [
	...
	{ path: CrrpRoutes.ORG_TERMS_AND_CONDITIONS, component: CrrpTermsAndCondsComponent },
	{ path: `${CrrpRoutes.INVITATION}/:id`, component: InvitationUserComponent },
	{ path: `${CrrpRoutes.INVITATION_LINK_ORG}/:id`, component: InvitationLinkOrganizationComponent },
];
