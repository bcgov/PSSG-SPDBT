		...
		<div class="row">
			<div class="col-12">
				<div class="conditions px-3 mb-3" (scroll)="onScrollTermsAndConditions($event)">
					...
					<p>
						In these Terms of Use, "you" or "your" includes the individual using or accessing the Organization Online
						Service Portal (the "Site").
					</p>
					<p>
						...
						govern your use of the Site and, where applicable, any associated service ("Associated Service" and,
					...
					<p>
						...
						Services, you agree, to the terms and conditions set out below.
					</p>
					<p>
					...
					<ol>
						...
						<li>
							You are required to be a Profile Manager for your Organization’s Business BCeID account to login, access
							or use the Services.
						</li>
						<li>
							Each time you access the Site, you must be authenticated by following an external link to the BCeID site,
							following which you will be returned to, and allowed to access the Site.
						</li>
						...
						<li>
							...
							requires, “Associated Service”) in order to pay the criminal record check fee for individual applicants
							for whom payment is required.
						</li>
						...
						<li>
							...
							Service, including the BCeID site, and/or the Payment Site, in which case your access to, and use of the
							services offered by, those Associated Services, including the BCeID site, and/ or the Payment Site, is
						...
						<li>
							You acknowledge and agree that at all times the Province and/or the providers of the Associated Services,
							or their respective licensors, are the owners of any software, hardware, servers, networks or other
						...
						<li>
							...
							<ol type="a">
								...
								<li>
									the Province or the provider of any Associated Service deems such suspension or cancellation necessary
									for any good and valid reason
								</li>
							</ol>
						</li>
						<li>
						...
						<li>
							...
							tort, strict liability or any other legal theory. The previous sentence will apply even if the Province or
							the provider of any Associated Service has been specifically advised of the possibility of any such loss,
