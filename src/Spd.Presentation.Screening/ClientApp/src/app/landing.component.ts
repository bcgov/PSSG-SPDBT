	...
	template: `
		<div class="landing-sections">
			<section class="step-section p-4">
				...
				<p class="mt-4 lead">Submit and manage criminal record checks for your employees or volunteers under Criminal Records Act <br>
				<a href="https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/00_96086_01" target="_blank">(CRRA).</a></p>

				<div class="option-label"><b>Option 1: Log in with your Business BCeID</b></div>
				<button mat-flat-button color="primary" class="large my-2" (click)="goToCrrp()">Business BCeID Account</button>
				<div class="option-label mt-4"><b>Option 2: Don't have a Business BCeID ?</b></div>
				<br>
