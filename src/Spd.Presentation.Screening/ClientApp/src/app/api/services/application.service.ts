...
export class ApplicationService extends BaseService {
	 ...
	 */
	apiOrgsOrgIdApplicationInvitesGet$Response(
		params: {
			orgId: string;
			filters?: string;
			page?: number;
	 ...
	 */
	apiOrgsOrgIdApplicationInvitesPost$Response(
		params: {
			orgId: string;
	 ...
	 * This method sends `application/*+json` and handles request body of type `application/*+json`.
	 */
	apiOrgsOrgIdApplicationInvitesPost(
		params: {
			orgId: string;
			body: ApplicationInvitesCreateRequest;
		},
	 ...
	 */
	static readonly ApiOrgsOrgIdApplicationInvitesApplicationInviteIdDeletePath =
		'/api/orgs/{orgId}/application-invites/{applicationInviteId}';
	 ...
	 * This method doesn't expect any request body.
	 */
	apiOrgsOrgIdApplicationInvitesApplicationInviteIdDelete$Response(
		params: {
		...
		const rb = new RequestBuilder(
			this.rootUrl,
			ApplicationService.ApiOrgsOrgIdApplicationInvitesApplicationInviteIdDeletePath,
			'delete'
		);
		if (params) {
	 ...
	 * This method sends `application/*+json` and handles request body of type `application/*+json`.
	 */
	apiApplicationInvitationPost$Response(
		params: {
			/**
	 ...
	 * This method doesn't expect any request body.
	 */
	apiOrgsOrgIdApplicationsBulkHistoryGet$Response(
		params: {
			orgId: string;
			sorts?: string;
			page?: number;
	 ...
	 */
	apiOrgsOrgIdApplicationsBulkPost$Response(
		params: {
			orgId: string;
			body?: {
				File?: Blob;
	 ...
	 * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
	 */
	apiOrgsOrgIdApplicationsBulkPost(
		params: {
			orgId: string;
			body?: {
				File?: Blob;
	 ...
	 * This method doesn't expect any request body.
	 */
	apiOrgsOrgIdApplicationStatisticsGet$Response(
		params: {
			orgId: string;
		},
		context?: HttpContext
	 ...
	 * This method doesn't expect any request body.
	 */
	apiOrgsOrgIdIdentityApplicationIdPut$Response(
		params: {
	 ...
	 * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
	 */
	apiOrgsOrgIdApplicationPost$Response(
		params: {
			/**
			 * organizationId
			 */
	 ...
	 * This method doesn't expect any request body.
	 */
	apiOrgsOrgIdApplicationsGet$Response(
		params: {
			orgId: string;
			filters?: string;
			sorts?: string;
	 ...
	 * This method doesn't expect any request body.
	 */
	apiOrgsOrgIdClearancesExpiredGet$Response(
		params: {
			orgId: string;
			filters?: string;
			sorts?: string;
	 ...
	 */
	static readonly ApiOrgsOrgIdClearancesExpiredClearanceAccessIdDeletePath =
		'/api/orgs/{orgId}/clearances/expired/{clearanceAccessId}';
	 ...
	 * This method doesn't expect any request body.
	 */
	apiOrgsOrgIdClearancesExpiredClearanceAccessIdDelete$Response(
		params: {
		...
		const rb = new RequestBuilder(
			this.rootUrl,
			ApplicationService.ApiOrgsOrgIdClearancesExpiredClearanceAccessIdDeletePath,
			'delete'
		);
		if (params) {
