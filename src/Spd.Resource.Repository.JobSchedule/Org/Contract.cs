...
namespace Spd.Resource.Repository.JobSchedule.Org
{
    public interface IOrgRepository
    {
        ...
        public Task<IEnumerable<ResultResp>> RunMonthlyOrgInChuncksAsync(RunJobRequest request, int concurrentRequests, CancellationToken cancellationToken, int delayInMilliSec = 400);
    }
}
