namespace Spd.Resource.Repository.JobSchedule.GeneralizeScheduleJob
{
    ...
    {
        public Task<IEnumerable<ResultResp>> RunJobInChunksAsync(RunJobRequest request, int ConcurrentRequests, CancellationToken cancellationToken, int delayInMilliSec);
    }
