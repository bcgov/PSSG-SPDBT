...
namespace Spd.Resource.Repository.Biz
{
    public class Mappings : Profile
    {
        public Mappings()
        {
            ...
            .ForPath(d => d.spd_bcbusinessaddresscity, opt => opt.MapFrom(s => s.BusinessAddress.City))
            .ForPath(d => d.spd_bcbusinessaddresscountry, opt => opt.MapFrom(s => s.BusinessAddress.Country))
            .ForPath(d => d.spd_bcbusinessaddresspostalcode, opt => opt.MapFrom(s => s.BusinessAddress.PostalCode))
            .ForPath(d => d.spd_bcbusinessaddressprovince, opt => opt.MapFrom(s => s.BusinessAddress.Province))
            .ForPath(d => d.spd_bcbusinessaddressline1, opt => opt.MapFrom(s => s.BusinessAddress.AddressLine1))
            .ForPath(d => d.spd_bcbusinessaddressline2, opt => opt.MapFrom(s => s.BusinessAddress.AddressLine2))
