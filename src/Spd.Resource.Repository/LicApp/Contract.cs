...
public record LicenceAppQuery(Guid? ApplicantId, Guid? BizId, List<WorkerLicenceType>? ValidWorkerLicenceTypeCodes, List<ApplicationPortalStatusEnum>? ValidPortalStatus);
