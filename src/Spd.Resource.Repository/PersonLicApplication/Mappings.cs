...
internal class Mappings : Profile
{
    public Mappings()
    {
        ...
        .ForMember(d => d.spd_height, opt => opt.MapFrom(s => SharedMappingFuncs.GetHeightStr(s)))
        .ForMember(d => d.spd_weight, opt => opt.MapFrom(s => SharedMappingFuncs.GetWeightStr(s)))
        .ReverseMap()
