...
internal class Mappings : Profile
{
    public Mappings()
    {
        ...
        .ForMember(d => d.spd_selfdisclosure, opt => opt.MapFrom(s => s.HasCriminalHistory/*(s.HasCriminalHistory.HasValue && s.HasCriminalHistory.Value) ? SharedMappingFuncs.GetYesNo(s.HasCriminalHistory) : null*/))
        ...
        .ForMember(d => d.spd_mentalhealthcondition, opt => opt.MapFrom(s => (s.IsTreatedForMHC.HasValue && s.IsTreatedForMHC.Value) ? SharedMappingFuncs.GetYesNo(s.IsTreatedForMHC) : null))
