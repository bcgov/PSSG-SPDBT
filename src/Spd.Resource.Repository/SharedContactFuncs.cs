...
internal static class SharedContactFuncs
{
        ...
        CancellationToken ct)
    {
        ...
        if (!MailingAddressIsSame(existingContact, newContact))
        {
        ...
        if (!ResidentialAddressIsSame(existingContact, newContact))
        {
            //put old address to spd_address
    ...
    {
        return (existed.firstname == newOne.firstname
            && existed.lastname == newOne.lastname
            && existed.spd_middlename1 == newOne.spd_middlename1
            && existed.spd_middlename2 == newOne.spd_middlename2);
    }

    private static bool MailingAddressIsSame(contact existingContact, contact newContact)
    {
        return (existingContact.address1_line1 == newContact.address1_line1
    ...
    {
        return (existingContact.address2_line1 == newContact.address2_line1
    ...
    private static contact UpdateExistingContact(contact existingContact, contact newContact)
    {
        ...
        existingContact.spd_middlename1 = newContact.spd_middlename1;
        existingContact.spd_middlename2 = newContact.spd_middlename2;
        existingContact.spd_sex = newContact.spd_sex;
