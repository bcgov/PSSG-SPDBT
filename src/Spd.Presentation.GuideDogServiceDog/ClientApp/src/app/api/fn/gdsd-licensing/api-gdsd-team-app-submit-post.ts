...
export function apiGdsdTeamAppSubmitPost(http: HttpClient, rootUrl: string, params: ApiGdsdTeamAppSubmitPost$Params, context?: HttpContext): Observable<StrictHttpResponse<GdsdAppCommandResponse>> {
