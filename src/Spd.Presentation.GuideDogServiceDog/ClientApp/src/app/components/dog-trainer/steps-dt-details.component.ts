...
import { StepDtTermsOfUseComponent } from './step-dt-terms-of-use.component';
...
export class StepsDtDetailsComponent extends BaseWizardStepComponent {
	...
	@ViewChild(StepDtTermsOfUseComponent) termsOfUseComponent!: StepDtTermsOfUseComponent;
