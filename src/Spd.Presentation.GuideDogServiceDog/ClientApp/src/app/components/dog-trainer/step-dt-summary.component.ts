						...
						<mat-accordion multi="true">
							<mat-expansion-panel class="mb-4" [expanded]="true" [disabled]="true">
								...
								<div class="panel-body">
									...
									<mat-divider class="mt-3 mb-2"></mat-divider>
									<div class="text-minor-heading-small">Confirmation from the accredited school</div>
									<div class="row mt-0">
										<div class="col-lg-6 col-md-12">
											<div class="summary-text-data">
												<ul class="m-0">
													@for (doc of accreditedSchoolConfirmationAttachments; track doc; let i = $index) {
														<li>{{ doc.name }}</li>
													}
												</ul>
											</div>
...
export class StepDtSummaryComponent implements OnInit, LicenceChildStepperStepComponent {
	...
	get accreditedSchoolConfirmationAttachments(): File[] | null {
		return this.dogTrainerApplicationService.getSummaryaccreditedSchoolConfirmationAttachments(
			this.dogTrainerModelData
		);
	}
