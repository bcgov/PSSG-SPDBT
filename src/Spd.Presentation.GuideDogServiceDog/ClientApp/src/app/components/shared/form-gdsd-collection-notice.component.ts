	...
	template: `
		<app-alert type="success" icon="">
			...
			<p>
				...
				requirements of the <i>Guide Dog and Service Dog Act</i> and its Regulation in accordance with s. 26(c) of the
				<i>Freedom of Information and Protection of Privacy Act</i> (FoIPPA). The use and disclosure of this information
				will comply with FoIPPA. If you have questions regarding the collection, use or disclosure of this information,
				please contact a Policy Analyst at
