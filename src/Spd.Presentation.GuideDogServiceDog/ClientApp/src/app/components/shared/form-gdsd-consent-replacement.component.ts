...
@Component({
	selector: 'app-form-gdsd-consent-replacement',
	template: `
		<form [formGroup]="form" novalidate>
			<div class="row">
				<div class="col-xxl-9 col-xl-10 col-lg-12 col-md-12 col-sm-12 mx-auto">
					...
					<div class="col-xl-6 col-lg-6 col-md-12 mt-4" *ngIf="showApplicantOrLegalGuardianName">
						<mat-form-field>
...
export class FormGdsdConsentReplacementComponent implements OnInit, LicenceChildStepperStepComponent {
	...
	@Input() showApplicantOrLegalGuardianName!: boolean;
