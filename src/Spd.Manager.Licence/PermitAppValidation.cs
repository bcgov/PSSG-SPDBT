...
public class PermitAppAnonymousSubmitRequestValidator : PersonalLicenceAppBaseValidator<PermitAppAnonymousSubmitRequest>
{
    public PermitAppAnonymousSubmitRequestValidator(IConfiguration configuration)
    {
        ...
        RuleFor(r => r.PermitOtherRequiredReason).NotEmpty()
            .When(r => 
            (r.ArmouredVehiclePermitReasonCodes.Contains(ArmouredVehiclePermitReasonCode.Other) && r.WorkerLicenceTypeCode == WorkerLicenceTypeCode.ArmouredVehiclePermit)||
            (r.BodyArmourPermitReasonCodes.Contains(BodyArmourPermitReasonCode.Other) && r.WorkerLicenceTypeCode == WorkerLicenceTypeCode.BodyArmourPermit));
        RuleFor(r => r.EmployerName).NotEmpty()
            ...
            && (r.ArmouredVehiclePermitReasonCodes.Contains(ArmouredVehiclePermitReasonCode.MyEmployment) && r.WorkerLicenceTypeCode == WorkerLicenceTypeCode.ArmouredVehiclePermit) ||
            (r.BodyArmourPermitReasonCodes.Contains(BodyArmourPermitReasonCode.MyEmployment) && r.WorkerLicenceTypeCode == WorkerLicenceTypeCode.BodyArmourPermit));
        ...
        RuleFor(r => r.EmployerPrimaryAddress).NotNull()
            ...
            && (r.ArmouredVehiclePermitReasonCodes.Contains(ArmouredVehiclePermitReasonCode.MyEmployment) && r.WorkerLicenceTypeCode == WorkerLicenceTypeCode.ArmouredVehiclePermit) ||
            (r.BodyArmourPermitReasonCodes.Contains(BodyArmourPermitReasonCode.MyEmployment) && r.WorkerLicenceTypeCode == WorkerLicenceTypeCode.BodyArmourPermit));
        RuleFor(r => r.EmployerPrimaryAddress.AddressLine1).NotEmpty()
            .MaximumLength(100)
            .When(r => r.EmployerPrimaryAddress != null);
        RuleFor(r => r.EmployerPrimaryAddress.AddressLine2).NotEmpty()
            .MaximumLength(100)
            .When(r => r.EmployerPrimaryAddress != null);
