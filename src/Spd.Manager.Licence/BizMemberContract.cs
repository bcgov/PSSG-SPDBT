...
public record BizControllingMemberNewInviteCommand(Guid BizContactId, Guid UserId, string HostUrl, ControllingMemberAppInviteTypeCode InviteType = ControllingMemberAppInviteTypeCode.New) : IRequest<ControllingMemberInvitesCreateResponse>;
